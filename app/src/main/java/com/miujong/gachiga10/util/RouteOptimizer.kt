...
import com.miujong.gachiga10.data.model.StationPoint
import com.miujong.gachiga10.data.model.TransitPathSegment
import com.miujong.gachiga10.data.model.TravelMode
import com.miujong.gachiga10.data.model.User
...
object RouteOptimizer {
    ...
    fun findGroups(
        ...
        val unassigned = users.toMutableList()
    ...
    fun decideLeader(
        ...
        return group.filter { userRoutes.containsKey(it.id) }
            .minByOrNull { user ->
                userRoutes[user.id]!!.distanceMeters
            }
    }
